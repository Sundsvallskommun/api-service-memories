...
class SeamanResourceFailureTest {
	...
	@Test
	void searchSeamenWithInvalidMunicipalityId() {
		...
		assertThat(response.getViolations())
			...
			.containsExactlyInAnyOrder(tuple("searchSeamen.municipalityId", "not a valid municipality ID"));

		verifyNoInteractions(serviceMock);
	}

	@Test
	void getSeamanByIdWithInvalidMunicipalityId() {
		final var response = webTestClient.get()
		...
		assertThat(response.getViolations())
			.extracting(Violation::field, Violation::message)
			.containsExactlyInAnyOrder(tuple("getSeaman.municipalityId", "not a valid municipality ID"));
