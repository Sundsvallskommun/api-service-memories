...
class PhotoMapperTest {
	...
	@Test
	void toPhoto() {
		final var result = PhotoMapper.toPhoto(sampleEntity(), "Sundsvall");
	...
	@Test
	void toPhotoWithNullLocationLeavesFieldNull() {
	...
	@Test
	void toPhotoWithNullEntityReturnsNull() {
		assertThat(PhotoMapper.toPhoto(null, "ignored")).isNull();
	}
