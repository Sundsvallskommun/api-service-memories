...
class InstitutionResourceFailureTest {
	...
	@Test
	void getInstitutionsWithInvalidMunicipalityId() {
		...
		assertThat(response.getViolations())
			...
			.containsExactlyInAnyOrder(tuple("getInstitutions.municipalityId", "not a valid municipality ID"));
