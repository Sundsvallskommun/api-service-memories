...
class FotoResourceFailureTest {
	...
	@Test
	void searchPhotosWithInvalidMunicipalityId() {
		...
		assertThat(response.getViolations())
			...
			.containsExactlyInAnyOrder(tuple("searchPhotos.municipalityId", "not a valid municipality ID"));

		verifyNoInteractions(serviceMock);
	}

	@Test
	void getPhotoByIdWithInvalidMunicipalityId() {
		final var response = webTestClient.get()
		...
		assertThat(response.getViolations())
			.extracting(Violation::field, Violation::message)
			.containsExactlyInAnyOrder(tuple("getPhoto.municipalityId", "not a valid municipality ID"));
	...
	void getPhotoFileWithInvalidMunicipalityId() {
		...
		assertThat(response.getViolations())
			.extracting(Violation::field, Violation::message)
			.containsExactlyInAnyOrder(tuple("getPhotoFile.municipalityId", "not a valid municipality ID"));
