	...
	public static Audio toAudio(final AudioEntity entity) {
		return ofNullable(entity)
			.map(e -> Audio.create()
				...
				.withCreatorPersonId(CreatorMapper.personId(e.getCreatorPerson()))
				.withCreatorPerson(CreatorMapper.personName(e.getCreatorPerson()))
				.withCreatorLegalEntityId(CreatorMapper.legalEntityId(e.getCreatorLegalEntity()))
				.withCreatorLegalEntity(CreatorMapper.legalEntityName(e.getCreatorLegalEntity()))
