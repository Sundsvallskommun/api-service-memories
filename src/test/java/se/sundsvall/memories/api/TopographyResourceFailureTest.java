...
class TopographyResourceFailureTest {
	...
	@Test
	void getTopographiesWithInvalidMunicipalityId() {
		...
		assertThat(response.getViolations())
			...
			.containsExactlyInAnyOrder(tuple("getTopographies.municipalityId", "not a valid municipality ID"));

		verifyNoInteractions(topographyServiceMock);
	}
}
